...
namespace Ex_0.Models
{
    public class AlunoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Nome,Email,Telefone,Curso")] Aluno aluno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Nome,Email,Telefone,Curso")] Aluno aluno)
        {
            if (ModelState.IsValid)
            {
