...
namespace CondominioEstribo.Controllers
{
    public class ProprietarioController : Controller
    {
        ...
        public ActionResult Index(string txtNomeProprietario)
        {
        ...
        public ActionResult ListarTodosProprietarios(string txtNomeProprietario)
        {
            var q = db.Proprietarios.AsQueryable();

            if (!string.IsNullOrEmpty(txtNomeProprietario))
                q = q.Where(x => x.Nome.Contains(txtNomeProprietario));
