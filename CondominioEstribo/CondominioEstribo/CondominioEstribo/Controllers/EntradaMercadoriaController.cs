...
namespace CondominioEstribo.Controllers
{
    public class EntradaMercadoriaController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EntradaMercadoriaId,ProdutoEntradaMercadoria,FornecedorEntradaMercadoria,QuantidadeInserida,ValorTotalDaNF,DataDaEntrada,Observacao")] EntradaMercadoria entradaMercadoria, string Produto, string Fornecedor)
        {

            string recebeProduto = Produto;
            ...
            string recebeFornecedor = Fornecedor;
            ...
            produto.QuantidadeAtual = produto.QuantidadeAtual + entradaMercadoria.QuantidadeInserida;
